# Proyecto 1 Laboratorio de Control Automatico

## Descripción del Repositorio
Este repositorio es para la entrega y presentación del primer proyecto del laboratorio de control automatico, donde se presenta el código de Mathlab para la simulación de un motor DC.
